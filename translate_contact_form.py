...
faq_keys = [
  ...
  'contactSend',
  'contactCancel',
  'contactEmptyErrorTitle',
  'contactEmptyErrorMessage'
]
...
def process_file(file):
    ...
    print(f"[{lang_code}] Starting Contact Form translation...")
    ...
    for key, text in en_translations.items():
        if key not in data or data[key] == text: # force translation if missing or identical
            try:
...
def main():
    ...
    print("Contact Form Translation script complete.")
