...
faq_keys = ["faqQ9", "faqA9", "faqQ10", "faqA10", "faqQ11", "faqA11", "faqQ12", "faqA12"]
...
def process_file(file):
    ...
    print(f"[{lang_code}] Starting FAQ 9-12 translation...")
...
def main():
    ...
    print("FAQ 9-12 Translation script complete.")
